...
inline std::string UTF8(const std::string& str) {
  return is_utf8(str.c_str(), str.size()) ? str : mbs_to_utf8(str);
}
  
/***********************************************************************************/

inline std::string UTF8(const char* str) {
  return is_utf8(str) ? std::string(str) : mbs_to_utf8(str);
}
